...
export default function InterrogatePage({ params }: InterrogatePageProps) {
  ...
  useEffect(() => {
    if (caseData && progress && !canInterrogateSuspect(progress, suspectName)) {
      router.push(`/dashboard/investigate/${resolvedParams.caseId}`);
    }
  }, [caseData, progress, suspectName, resolvedParams.caseId, router]);
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => setInterrogationComplete(true)}
